...
from lib.tracelib.trace_client import TraceClient, environment_opts_out
...
class TraceClientTest(unittest.TestCase):
    ...
    def test_user_agent_names_the_client_version(self):
        from lib.tracelib.trace_client import __version__
    ...
    def test_json_drops_nan_and_none_tags(self):
        from lib.tracelib.trace_client import _json
